...
/// @title FCCPlaceholder Contract
/// @author pureland
/// @dev The FCCPlaceholder contract will take control over the FCC after the contribution
///  is finalized and before the ATMatrix Network is deployed.
///  The contract allows for FCC transfers and transferFrom and implements the
///  logic for transferring control of the token to the network when the offering
///  asks it to do so.


import "./MiniMeToken.sol";
import "./FCCContribution.sol";
import "./SafeMath.sol";
import "./Owned.sol";
