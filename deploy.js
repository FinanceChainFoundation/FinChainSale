...
module.exports ={
    ...
    deploy:function(contract,contractName,cb){
        var rpcAddress=getRpcStr.get()

        contract.new().then(function(instance){

            rpcAddress[contractName]='"'+instance.address+'"';
            console.log('deploy %s:%s',contractName,instance.address)
            getRpcStr.save(rpcAddress,cb)
        });
    },
